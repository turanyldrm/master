 ...
 * @constructor Turan YILDIRIM
 * @colorPicker - Collect the color from the user
 * @sizePicker - Collect the height and width parameters
 * @pixelCanvas - represents the grid made by user
 */
